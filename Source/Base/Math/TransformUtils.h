...
inline glm::vec3 GetX(const glm::mat4& mat)
{
    return glm::vec3(mat[0][0], mat[0][1], mat[0][2]);
}

inline glm::vec3 GetY(const glm::mat4& mat)
{
    return glm::vec3(mat[1][0], mat[1][1], mat[1][2]);
}

inline glm::vec3 GetZ(const glm::mat4& mat)
{
    return glm::vec3(mat[2][0], mat[2][1], mat[2][2]);
}

inline glm::vec3 GetTranslation(const glm::mat4& mat)
{
